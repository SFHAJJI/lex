    ...
    public static string Page(string publicBase, string title, string body,
        ...
        <style>
          ...
          * { box-sizing:border-box }
          ...
          .cat th:nth-child(4), .cat td:nth-child(4),
          .cat th:nth-child(5), .cat td:nth-child(5) { white-space:nowrap }
          ...
          @media (max-width:640px) {
            ...
            .cat th:nth-child(2), .cat td:nth-child(2),
            .cat th:nth-child(4), .cat td:nth-child(4) { display:none }
            .cat th, .cat td { padding-left:6px; padding-right:6px }
            .cat td:first-child { min-width:170px }
          }
        </style></head>
        <body>
        <header>
