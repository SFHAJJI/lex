        ...
        <style>
          ...
          * { box-sizing:border-box }
          ...
          @media (max-width:640px) {
            ...
            /* Type is already available as a filter and the first date is secondary to the
               latest state. Removing those columns leaves the law, version count, latest date
               and text availability readable instead of spelling dates vertically. */
            .cat th:nth-child(3), .cat td:nth-child(3),
            .cat th:nth-child(5), .cat td:nth-child(5),
            .cat th:nth-child(6), .cat td:nth-child(6) { display:none }
            .cat th, .cat td { padding-left:6px; padding-right:6px }
