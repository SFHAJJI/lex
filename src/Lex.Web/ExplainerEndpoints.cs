...
public static class ExplainerEndpoints
{
        ...
        RetrievalMetricObservation observation, string format, string suffix = "")
    {
        ...
        return $"{observation.RequireMeasuredValue().ToString(format, CultureInfo.InvariantCulture)}{suffix} "
    ...
    public static IEndpointRouteBuilder MapExplainers(this IEndpointRouteBuilder app, WebContext ctx)
    {
        ...
        app.MapGet("/verify", () =>
        {
            ...
            var body = $$"""
                ...
                <p class="sub">Extraction profiles are immutable (<span class="mono">akn-lu/1</span>, <span class="mono">akn-lu/2</span>, <span class="mono">akn-lu-identical-scl-duplicate/1</span>, <span class="mono">akn-lu-document/1</span>,
        ...
        app.MapGet("/developers", () =>
        {
            ...
            var body = $$"""
                ...
                <h2 id="assistant-data">Assistant availability</h2>
                <div class="card">
                <p>The assistant is temporarily unavailable while Lex installs its deterministic V3 answer
                path, checkable against its sources. Search and held publisher text remain available.</p>
