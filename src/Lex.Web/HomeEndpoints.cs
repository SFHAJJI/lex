    ...
    public static IEndpointRouteBuilder MapHome(this IEndpointRouteBuilder app, WebContext ctx)
    {
        ...
        app.MapGet("/", () =>
        {
            ...
            var body = $"""
                ...
                <p class="sub"><a href="/developers#assistant">Connect your own AI</a>
                ...
                <nav class="fork" aria-label="Where to go next">
                  ...
                  <a href="/built"><b>I want to inspect the engineering</b><span>Architecture, decisions, benchmarks, failures and verifiable artifacts.</span></a>
                </nav>
                </div>
                """
                + $$"""
