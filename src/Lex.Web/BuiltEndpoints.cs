...
public static class BuiltEndpoints
{
    ...
    [
        ...
        new("assistant", "/built/assistant", "Assistant", "Reviewed V3 answer-path design; the public assistant is temporarily unavailable.",
            "The reviewed typed planning and evidence design for the replacement Lex answer path."),
