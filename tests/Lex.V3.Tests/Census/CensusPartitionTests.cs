...
public sealed class CensusPartitionTests
{
    ...
    {
        Assert.AreEqual(
            467, ClosedSurfaceCensus.Candidates(CensusScope.SweptHere).Count, "candidates");
        Assert.AreEqual(
        ...
        Assert.AreEqual(
            62, ClosedSurfaceCensus.VocabularyRegistries(CensusScope.SweptHere).Count, "registries");
