...
public sealed class CensusPartitionTests
{
    ...
    {
        Assert.AreEqual(
            581, ClosedSurfaceCensus.Candidates(CensusScope.SweptHere).Count, "candidates");
        Assert.AreEqual(
        ...
        Assert.AreEqual(
            69, ClosedSurfaceCensus.VocabularyRegistries(CensusScope.SweptHere).Count, "registries");
