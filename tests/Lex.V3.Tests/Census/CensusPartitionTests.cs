...
public sealed class CensusPartitionTests
{
    ...
    {
        Assert.AreEqual(
            464, ClosedSurfaceCensus.Candidates(CensusScope.SweptHere).Count, "candidates");
        Assert.AreEqual(
        ...
        Assert.AreEqual(
            60, ClosedSurfaceCensus.VocabularyRegistries(CensusScope.SweptHere).Count, "registries");
