    ...
    public void EveryStaticTokenRegistryInTheSweptAssembliesIsPinnedAtItsCurrentSize()
    {
        CollectionAssert.AreEqual(
            new[]
            {
                ...
                "Lex.V3.Contracts.Source.Europe.EuMemberStateDisclaimer: const SourceUri, "
                    + "const Text",
                ...
                "Lex.V3.Contracts.Source.Luxembourg.LuxembourgLiteralCanonicalizer: "
                    ...
                    + "const XsdString",
                "Lex.V3.Contracts.Source.Luxembourg.LuxembourgOpinionLinkOnlyVocabulary: "
                    + "AdmittedHostFamilies=3, const HasOpinionPredicateIri, "
                    + "const HasResultingOpinionDocumentPredicateIri, const Jolux, "
                    + "const OpinionConseilEtatClassIri, const OpinionDatePredicateIri, "
