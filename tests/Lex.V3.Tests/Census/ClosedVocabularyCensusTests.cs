    ...
    public void EveryClosedVocabularyInTheSweptAssembliesIsPinnedMemberByMember()
    {
        CollectionAssert.AreEqual(
            new[]
            {
                ...
                "Lex.V3.Contracts.Evaluation.ControlVerdict: CaughtTheShuffle, MissedTheShuffle, "
                    + "NotApplicable",
                "Lex.V3.Contracts.Evaluation.EvaluationCaseKind: Retrieval, ExactIdentifier",
                ...
                "Lex.V3.Contracts.Source.Europe.EuProcedureEventQueryPass: Pass1, Pass2",
                ...
                "Lex.V3.Contracts.Source.Luxembourg.LuxembourgReferralDateState: Fact, "
