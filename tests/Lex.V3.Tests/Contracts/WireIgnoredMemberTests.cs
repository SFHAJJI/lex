...
public sealed class WireIgnoredMemberTests
{
    ...
    [
        ...
        new("RelationFact", "TargetEcli", "target_ecli", "\"ECLI:EU:C:2019:1\"",
            static () => FactsFixtures.AssertedFact(),
            "v3-facts/relation-fact.schema.json"),
        new("EuTranspositionSourceAcquisition", "ProvesAbsence", "proves_absence", "false",
        ...
        new("EuNormalisedEliJoin", "IsDerived", "is_derived", "false",
            static () => new EuNormalisedEliJoin(
                "http://data.legilux.public.lu/eli/etat/leg/loi/2018/08/01",
                new SourceArtifactRef("urn:uuid:00000000-0000-4000-8000-00000000c502", Digest)),
            null),
    ...
    public void TheCorpusCoversEveryConvertedMember()
    {
        ...
        CollectionAssert.AreEqual(
            new[]
            {
                ...
                "EuNormalisedEliJoin.IsDerived",
                "EuTranspositionSourceAcquisition.ProvesAbsence",
