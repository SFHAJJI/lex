...
public sealed class V3EnvelopeJsonTests
{
    ...
    private const string RegistryDigest = "13ac5f0c992ad71ad0524698966395873dabf4b5de6dcbb91a05bea0d559b0f1";
    private const string ExpectedSuccess = """{"context":{"freshness":{"observed_at":"2026-09-17T00:00:00.0000000Z","upstream_health":"current"},"jurisdiction":"lu","provisional":false,"publisher":"lu-legilux","snapshot":{"snapshot_id":"snapshot","snapshot_sha256":"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"},"status":"success","timeline_semantics":"publisher_applicability"},"object_type":"envelope","operation_id":"resolve","refusal":null,"registry_schema":"lex-v3-operation-registry/1","registry_sha256":"13ac5f0c992ad71ad0524698966395873dabf4b5de6dcbb91a05bea0d559b0f1","request_ref":"req","result":{"object_type":"work_resolution","schema":"lex-v3-resolve-result/1","value":{"work_id":"lu-legilux:arr\u00EAt\u00E9 \u0026 co"}},"schema":"lex-v3-envelope/1","verdict":"answer","version":"v3"}""" + "\n";
    private const string ExpectedRefusal = """{"context":{"freshness":{"observed_at":"2026-09-17T00:00:00.0000000Z","upstream_health":"current"},"jurisdiction":"lu","provisional":false,"publisher":"lu-legilux","snapshot":{"snapshot_id":"snapshot","snapshot_sha256":"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"},"status":"refusal","timeline_semantics":"publisher_applicability"},"object_type":"envelope","operation_id":"resolve","refusal":{"code":"no_corpus_mounted","helpful_payload":{"required_corpus":"lu"},"schema":"lex-v3-refusal/1"},"registry_schema":"lex-v3-operation-registry/1","registry_sha256":"13ac5f0c992ad71ad0524698966395873dabf4b5de6dcbb91a05bea0d559b0f1","request_ref":"req","result":null,"schema":"lex-v3-envelope/1","verdict":"refuse","version":"v3"}""" + "\n";
