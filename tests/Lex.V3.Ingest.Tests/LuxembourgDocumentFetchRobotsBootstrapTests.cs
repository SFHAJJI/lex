...
public sealed class LuxembourgDocumentFetchRobotsBootstrapTests
{
    ...
    [TestMethod]
    public async Task ADisallowedPageDoesNotBlockItsPermittedFilestoreXml()
    {
        ...
        Assert.IsNull(result.DeniedRequestPath);
        result.Session?.Dispose();
    }

    [TestMethod]
    public async Task ADisallowedActPageDoesNotBlockItsPermittedMemorialPdf()
    {
        const string filestorePath =
