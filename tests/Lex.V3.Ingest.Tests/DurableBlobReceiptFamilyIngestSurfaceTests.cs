    ...
    public void EveryHolderOfReceiptInIngestIsPinnedAndNoneIsAConstructor()
    {
        CollectionAssert.AreEqual(
            new[]
            {
                ...
                "field private instance Lex.V3.Ingest.Stage3EuropeBodyComposition::<PdfCustody>k__BackingField -> " + Receipt,
                "field private instance Lex.V3.Ingest.Stage3EuropeBodyComposition::<XhtmlCustody>k__BackingField -> " + Receipt,
                ...
                "property public instance Lex.V3.Ingest.Stage3EuropeBodyComposition::FormexCustody() -> " + Receipt,
                "property public instance Lex.V3.Ingest.Stage3EuropeBodyComposition::PdfCustody() -> " + Receipt,
                "property public instance Lex.V3.Ingest.Stage3EuropeBodyComposition::XhtmlCustody() -> " + Receipt,
