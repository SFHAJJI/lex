...
//
// Two captures, both fetched from the production MCP endpoint on 2026-09-01:
//
//   - RGD of 10 May 1999 defining the illnesses of exceptional gravity under the parental leave
//     law, in its 2020-03-14 and 2020-09-25 consolidations.
//   - Both publishers' coverage payloads.
...
//
// These are here because the facet reconciliation rules were a design decision that could have
// been got wrong in a way no synthetic fixture would have shown. The thin fixture has one
// language row, so under it the language table and the document-type table look like the same
// kind of thing, and applying one rule to both looks obviously right.
//
