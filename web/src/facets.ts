...
const LABELS: Record<string, string> = {
  ...
  LOI: "Luxembourg law", CODE: "Luxembourg code", Constitution: "Luxembourg Constitution",
  RGD: "Grand-ducal regulation", RMIN: "Ministerial regulation", AMIN: "Ministerial order",
  AGD: "Grand-ducal order", CONV: "Convention", PROT: "Protocol", ORD: "Ordinance",
  RECUEIL: "Luxembourg thematic collection", CODE_RECUEIL: "Luxembourg code collection",
